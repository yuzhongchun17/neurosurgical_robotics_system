function []=bez_plots(T_base,T_tip,control_pts)
...
line_scale=0.08*Lpp; %0.06*Lpp;
tip_tan_start=[P4(1); P4(3)];
tip_tan_end=tip_tan_start+0.15*Lpp*[V4(1); V4(3)];
base_tan_start=[P0(1); P0(3)];
base_tan_end=base_tan_start+0.15*Lpp*[V0(1); V0(3)];
...
arrow(tip_tan_start,tip_tan_end,'Length',10,'Width',line_scale/10,'BaseAngle',90,'TipAngle',24)		% tip tangent
arrow(base_tan_start,base_tan_end,'Length',10,'Width',line_scale/10,'BaseAngle',90,'TipAngle',24)	% base tangent
xlabel('X'); ylabel('Z'); %title('Resultant Curve')
legend([Bez,CP],'Curve','Control Polygon','Location','northwest')
