...
function le_points=pose2curve2(T_tip)
...
line_scale=0.08*L_PP; %0.06*Lpp;
tip_tan_start=[P4(1); P4(3)];
tip_tan_end=tip_tan_start+0.15*L_PP*[V4(1); V4(3)];
base_tan_start=[P0(1); P0(3)];
base_tan_end=base_tan_start+0.15*L_PP*[V0(1); V0(3)];
...
bez_plots(T_base,T_tip,le_points_guess)
%}
