...
figure
	...
	plot(tip_normal(1,:),tip_normal(2,:),'b')	% the tip normal (to help it be clear on the plot)
	plot(base_normal(1,:),base_normal(2,:),'b')	% the tip normal (to help it be clear on the plot)
	arrow(tip_tan_start,tip_tan_end,'Length',12*w_ar,'Width',w_ar,'BaseAngle',90,'TipAngle',20)		% tip tangent
	arrow(base_tan_start,base_tan_end,'Length',12*w_ar,'Width',w_ar,'BaseAngle',90,'TipAngle',20)	% base tangent
	axis([xmin xmax ymin ymax])
% subplot(1,3,3)
figure
	plot(xB,zB,'k')	% the curve
	...
	plot(tip_normal(1,:),tip_normal(2,:),'b')	% the tip normal (to help it be clear on the plot)
	plot(base_normal(1,:),base_normal(2,:),'b')	% the tip normal (to help it be clear on the plot)
	arrow(tip_tan_start,tip_tan_end,'Length',10*w_ar,'Width',w_ar,'BaseAngle',90,'TipAngle',20)		% tip tangent
	arrow(base_tan_start,base_tan_end,'Length',10*w_ar,'Width',w_ar,'BaseAngle',90,'TipAngle',20)	% base tangent
	axis([xmin xmax ymin ymax])
