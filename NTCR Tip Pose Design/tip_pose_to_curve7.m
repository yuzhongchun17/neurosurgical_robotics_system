...
%% Desired Parameters
curve_option=1;
x_des=15; z_des=0; tip_angle=pi; %note-- this is an angle off the vertical in the clockwise direction
...
%%{
p2_bound=1;
LB=[0.1*L_PP, 0.1*L_PP, P2g(1)-p2_bound*L_PP,P2g(3)-p2_bound*L_PP]; UB=[L_PP, L_PP, P2g(1)+p2_bound*L_PP,P2g(3)+p2_bound*L_PP];
...
tip_tan_end=tip_tan_start+1.5*[V4(1); V4(3)];
base_tan_start=[P0(1); P0(3)];
base_tan_end=base_tan_start+1.5*[V0(1); V0(3)];
