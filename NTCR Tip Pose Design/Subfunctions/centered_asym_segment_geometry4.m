function Ix=centered_asym_segment_geometry4(g,do,t,g_tol)
%% WORK IN PROGRESS. NEED TO CHANGE THE WAY go AND gi ARE RELATED. NEED TO RESTRICT gs FURTHER.
...
A=A_center;
Ix=Ix_center;%-A*ybar^2;   % Use parallel axis theorem to get it about ybar.
end